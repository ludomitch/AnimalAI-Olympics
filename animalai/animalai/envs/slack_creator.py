...
arenas:
  -1: !Arena
    ...
    - !Item
      ...
      - !RGB {r: 0, g: 0, b: 255}
      sizes:
      - !Vector3 {x: 5, y: 2, z: 15}
      - !Vector3 {x: 15, y: 2, z: 2}
    - !Item
      name: GoodGoal
      positions:
      - !Vector3 {x: 35, y: 2, z: 30}      
      sizes:
      - !Vector3 {x: 2, y: 2, z: 2}
    - !Item
      name: DeathZone
...
arenas:
  -1: !Arena
    ...
    - !Item
      name: Agent
      positions:
      - !Vector3 {x: 10, y: 1, z: 18}
      rotations: [0]
    - !Item
      name: Wall
      positions:
      - !Vector3 {x: 10, y: 0, z: 25}
      - !Vector3 {x: 20, y: 0, z: 30}
      - !Vector3 {x: 30, y: 0, z: 25}
      rotations: [0,0,0]
      colors: 
      - !RGB {r: 0, g: 0, b: 255}
      - !RGB {r: 0, g: 0, b: 255}
      - !RGB {r: 0, g: 0, b: 255}
      sizes:
      - !Vector3 {x: 4, y: 1, z: 15}
      - !Vector3 {x: 16, y: 1, z: 2}
      - !Vector3 {x: 4, y: 1, z: 15}
    - !Item
      name: GoodGoal
      positions:
      - !Vector3 {x: 30, y: 1, z: 20}      
      sizes:
      - !Vector3 {x: 2, y: 2, z: 2}
    - !Item
      name: DeathZone
